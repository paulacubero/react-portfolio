    ...
    <div className={"formationWrapper"}>
      <div className={"mainFormationWrapper"}>
        <a
          ...
          class="mx-auto block w-fit sm:mx-0 cursor-pointer"
        >
          {" "}
          <h2 class="text-2xl font-semibold">/paulacubero</h2>{" "}
        </a>
        <div class="py-4 text-secondary sub-formacion flex flex-col sm:flex-row items-center justify-between gap-y-4">
          {" "}
          <p>© By PaulaCubero.</p>{" "}
